...
void fn_1_458(OMOBJ *object);
void fn_1_4FC(OMOBJ *object);

void fn_1_1260(HUPROCESS *objman);
void fn_1_6E5C(OMOBJ *object);
...
{
    lbl_1_bss_928 = 30;
    lbl_1_bss_926 = REFRESH_RATE;
    fn_1_1250(0);
    lbl_1_bss_924 = -1;
    WipeCreate(WIPE_MODE_IN, WIPE_TYPE_NORMAL, 60);
    lbl_1_bss_920 = 1;
    fn_1_8FF4(1);
    object->objFunc = fn_1_4FC;
}
...
void fn_1_4FC(OMOBJ *object)
{
    ...
    switch (fn_1_1240()) {
        ...
        case 1:
            if (--lbl_1_bss_95C == 0) {
                fn_1_1250(2);
                lbl_1_bss_95C = REFRESH_RATE * 1.4;
            }
            break;
        ...
        case 2:
            if (lbl_1_bss_95C) {
                ...
                if (lbl_1_bss_920 > 0) {
                    lbl_1_bss_920 -= 1.2f * REFRESH_FREQ;
                    if (lbl_1_bss_920 < 0) {
                        lbl_1_bss_920 = 0;
                    }
                    Hu3DGLightColorSet(
        ...
        case 3:
            if (--lbl_1_bss_95C == 0) {
                ...
                fn_1_8FF4(0.0625f);
                Hu3DShadowData.fov = 135;
                MTXLightPerspective(Hu3DShadowData.projMtx, Hu3DShadowData.fov, 1.2f, 0.5f, -0.5f, 0.5f, 0.5f);
                lbl_1_bss_918 = 1;
        ...
        case 9:
            if (fn_1_14E8()) {
                if (--lbl_1_bss_95C == 0) {
                    fn_1_1250(10);
                    lbl_1_bss_95C = REFRESH_RATE * 3.5;
...
void fn_1_156C(OMOBJ *object);
void fn_1_2930(OMOBJ *object);
...
void fn_1_1964(OMOBJ *object);
void fn_1_1ADC(OMOBJ *object);
void fn_1_1D84(OMOBJ *object);

void fn_1_6AE8(HU3DMODEL *model, HU3DPARTICLE *particle, Mtx matrix);
...
void fn_1_156C(OMOBJ *object)
{
    ...
    object->mdlId[0] = CharModelCreate(work->unk0C, 4);
    ...
    fn_1_8EB4(object->mdlId[1]);
    Hu3DMotionSet(object->mdlId[0], object->mtnId[0]);
    Hu3DModelAttrSet(object->mdlId[0], HU3D_MOTATTR_LOOP);
    CharMotionNoSet(work->unk0C, object->mtnId[1], DATA_MAKE_NUM(DATADIR_MARIOMOT, 0x02));
    CharMotionNoSet(work->unk0C, object->mtnId[2], DATA_MAKE_NUM(DATADIR_MARIOMOT, 0x02));
    CharMotionDataClose(work->unk0C);
    object->mdlId[4] = Hu3DParticleCreate(lbl_1_bss_914, 2);
    Hu3DParticleHookSet(object->mdlId[4], fn_1_6AE8);
    Hu3DParticleBlendModeSet(object->mdlId[4], 1);
...
void fn_1_1964(OMOBJ *object)
{
    ...
    for (i = 0; i < 9; i++) {
        if (!lbl_1_data_10C[i][1]) {
            object->mtnId[i] = CharMotionCreate(work->unk0C, lbl_1_data_10C[i][0]);
        }
        else {
            object->mtnId[i] = CharMotionCreate(work->unk0C, work->unk0C + lbl_1_data_10C[i][0]);
        }
    }
    object->mdlId[1] = Hu3DModelCreateFile(DATA_MAKE_NUM(DATADIR_M416, 0x03));
    object->mdlId[2] = Hu3DParticleCreate(HuSprAnimReadFile(DATA_MAKE_NUM(DATADIR_M416, 0x06)), 100);
    Hu3DParticleHookSet(object->mdlId[2], fn_1_613C);
    Hu3DParticleBlendModeSet(object->mdlId[2], 1);
    Hu3DModelLayerSet(object->mdlId[2], 6);
    Hu3DModelAttrSet(object->mdlId[2], HU3D_ATTR_ZWRITE_OFF);
    Hu3DModelAttrSet(object->mdlId[2], HU3D_ATTR_DISPOFF);
    work->unk44 = 5;
    work->unk48 = fn_1_29DC;
}

void fn_1_2EA4(OMOBJ *object);
void fn_1_6640(HU3DMODEL *model, HU3DPARTICLE *particle, Mtx matrix);
...
void fn_1_1ADC(OMOBJ *object)
{
    ...
    work = object->data;
    for (i = 0; i < 9; i++) {
        object->mtnId[i] = CharMotionCreate(work->unk0C, lbl_1_data_154[i]);
    }
    object->mdlId[1] = Hu3DModelCreateFile(DATA_MAKE_NUM(DATADIR_M416, 0x04));
    object->mdlId[2] = Hu3DModelCreateFile(DATA_MAKE_NUM(DATADIR_M416, 0x02));
...
void fn_1_389C(OMOBJ *object);
s32 fn_1_5530(OMOBJ *arg0, Vec *arg1, Vec *arg2);
...
void fn_1_1D84(OMOBJ *object)
{
            ...
            if (fn_1_1240() >= 6) {
                if (fn_1_1240() == 7) {
                    ...
                    if (temp_f28 > 0) {
                        ...
                        temp_r31->unk18 = ((600.0f / REFRESH_RATE_F) * temp_f28) / 72;
                        ...
                        if (temp_r31->unk18 < (450.0f / REFRESH_RATE_F)) {
                            temp_r29 = 1;
                        }
                        else {
                            temp_r29 = 2;
        ...
        case 2:
            if (fn_1_1240() == 10) {
                ...
                if (temp_f28 < 20 || temp_r31->unk40 == 0) {
                    ...
                    if (!temp_r27) {
                        if (temp_f28 < 100.0f) {
                            temp_f23 = (450.0f / REFRESH_RATE_F) * (temp_f28 / 100.0f);
                        }
                        else {
                            temp_f23 = (450.0f / REFRESH_RATE_F);
                        }
                    }
                    else {
                        temp_f23 = (225.0f / REFRESH_RATE_F);
                    }
    ...
    if ((temp_r29 >= 0 && temp_r29 != temp_r31->unk28) || temp_r28 != temp_r31->unk30) {
        ...
        CharMotionShiftSet(temp_r31->unk0C, object->mtnId[temp_r31->unk28], 0, 8, temp_r28);
    }
}

void fn_1_5004(void);

void fn_1_361C(OMOBJ *object);
...
void fn_1_29DC(OMOBJ *object)
{
    ...
    if (temp_r31->unk44 > 0 && temp_r31->field_0_bit0) {
        ...
        temp_r31->unk46 = REFRESH_RATE;
        temp_r31->unk60 = REFRESH_RATE / 2;
    ...
    if (temp_r31->field_0_bit2) {
        Hu3DModelObjMtxGet(object->mdlId[0], "test11_tex_we-itemhook-r", sp50);
        MTXTrans(sp20, 0, 52, 0);
        MTXConcat(sp50, sp20, sp50);
        Hu3DModelPosSet(object->mdlId[2], sp50[0][3], sp50[1][3], sp50[2][3]);
        Hu3DModelScaleSet(object->mdlId[2], lbl_1_data_180[temp_r31->unk44], lbl_1_data_180[temp_r31->unk44], lbl_1_data_180[temp_r31->unk44]);
    }
    if (fn_1_1240() >= 4 && fn_1_1240() <= 8 && lbl_1_bss_91A[1] >= 0) {
        ...
        temp_r29 = &Hu3DData[object->mdlId[2]];
        sp8 = temp_r29->pos;
        sp14 = sp8;
        sp14.y = 800;
        sp8.y = 0;
...
void fn_1_2EA4(OMOBJ *object)
{
    ...
    switch (temp_r30->unk50) {
        ...
        case 1:
            if (--temp_r30->unk60 == 0) {
                Hu3DModelObjMtxGet(object->mdlId[0], "test11_tex_we-itemhook-r", sp3C);
                MTXTrans(spC, 0, 2, 50);
                MTXConcat(sp3C, spC, sp3C);
                Hu3DModelPosSet(object->mdlId[2], sp3C[0][3], sp3C[1][3], sp3C[2][3]);
                Hu3DModelScaleSet(object->mdlId[2], 0.5f, 0.5f, 0.5f);
                Hu3DModelAttrReset(object->mdlId[2], HU3D_ATTR_DISPOFF);
                Hu3DMotionTimeSet(object->mdlId[2], 0);
                Hu3DMotionSpeedSet(object->mdlId[2], 2.0f);
                Hu3DModelRotSet(object->mdlId[2], 0, 180.0f + object->rot.y, 0);
                Hu3DData[object->mdlId[2]].motShapeWork.time = 0;
                Hu3DData[object->mdlId[2]].motShapeWork.speed = 2;
                Hu3DModelAttrReset(object->mdlId[3], HU3D_ATTR_DISPOFF);
                Hu3DModelPosSet(object->mdlId[3], sp3C[0][3], sp3C[1][3], sp3C[2][3]);
                temp_r27 = &Hu3DData[object->mdlId[3]];
                temp_r28 = temp_r27->hookData;
                temp_r28->dataCnt = 0;
                temp_r28->pos.x = sp3C[0][3];
                temp_r28->pos.y = sp3C[1][3];
                temp_r28->pos.z = sp3C[2][3];
                temp_r28->unk_10.x = object->rot.y;
#if VERSION_PAL
                temp_r28->prevCount = 30 - (sqrtf((2.0f * temp_r28->pos.y) / 1.2f) / 2.0f);
#else
                temp_r28->prevCount = 30 - (sqrtf((2.0f * temp_r28->pos.y) / 1.0000001f) / 2.0f);
#endif
                temp_r29->field_0_bit0 = 1;
                temp_r30->unk50 = 2;
                temp_r30->unk60 = REFRESH_RATE / 3;
            }
            break;
        ...
        case 3:
            if (--temp_r30->unk60 == 0) {
                Hu3DModelAttrSet(object->mdlId[2], HU3D_ATTR_DISPOFF);
                Hu3DData[object->mdlId[2]].motIdShape = -1;
...
void fn_1_361C(OMOBJ *object)
{
    ...
    if (temp_r30->field_0_bit2) {
        if (fn_1_1240() == 9) {
            ...
            temp_r30->unk60 = REFRESH_RATE / 2;
            temp_r29 = &Hu3DData[object->mdlId[1]];
            temp_r29->rot.y = object->rot.y;
            Hu3DModelObjPosGet(object->mdlId[0], "test11_tex_we-itemhook-r", &temp_r29->pos);
            Hu3DModelHookReset(object->mdlId[0]);
            Hu3DModelAttrReset(object->mdlId[1], HU3D_ATTR_HOOK);
            Hu3DModelShadowReset(object->mdlId[1]);
            Hu3DModelAttrReset(object->mdlId[0], HU3D_ATTR_DISPOFF);
        }
    }
    else {
        ...
        if (--temp_r30->unk60 == 0) {
            ...
            Hu3DModelPosSet(object->mdlId[4], temp_r29->pos.x, temp_r29->pos.y, temp_r29->pos.z);
...
void fn_1_38F0(OMOBJ *object);
void fn_1_49C4(OMOBJ *object);
...
void fn_1_49C4(OMOBJ *object)
{
    ...
    switch (temp_r31->unk70) {
        ...
        case 1:
            sp20.x = temp_r30->trans.x + ((REFRESH_RATE_F * temp_r28->unk1C.x) / 4.0f);
            sp20.z = temp_r30->trans.z + ((REFRESH_RATE_F * temp_r28->unk1C.z) / 4.0f);
...
{
    s32 i = 0;
    OMOBJ **sp8 = omGetGroupMemberListEx(HuPrcCurrentGet(), 0);
...
void fn_1_613C(HU3DMODEL *model, HU3DPARTICLE *particle, Mtx matrix)
{
    float temp_f31;
    float temp_f30;
    float temp_f29;
    ...
    if (!particle->dataCnt) {
        ...
        for (temp_r29 = 0; temp_r29 < particle->maxCnt; temp_r31++, temp_r29++) {
            temp_r31->vel.x = (4.0f * ((1.0f / 256.0f) * frand8())) + 8;
            temp_r31->pos.x = (4.0f * (((1.0f / 256.0f) * ((s32)frand() & 0x1FF)) - 1));
            temp_r31->pos.y = (64.0f * ((1.0f / 256.0f) * frand8()));
            temp_r31->pos.z = (4.0f * (((1.0f / 256.0f) * ((s32)frand() & 0x1FF)) - 1));
            temp_r31->zRot = 360.0f * ((1.0f / 256.0f) * frand8());
            temp_r31->time = frand8();
            temp_r31->parManId = (frand() & 0x3) + 4;
        }
        temp_f29 = temp_f28 = 0;
    }
    else {
        temp_f29 = (particle->pos.x - model->pos.x);
        temp_f28 = (particle->pos.z - model->pos.z);
    }
    temp_r31 = particle->data;
    for (temp_r29 = 0; temp_r29 < particle->maxCnt; temp_r31++, temp_r29++) {
        temp_f30 = temp_r31->time / 255.0f;
        temp_f31 = temp_f30 * temp_f30;
        temp_r31->pos.x += temp_f29 * temp_f31;
        temp_r31->pos.y = 60.0f * temp_f30;
        temp_r31->pos.z += temp_f28 * temp_f31;
        temp_r31->color.a = 255.0f * (1.0f - temp_f30);
        temp_f31 = 0.5 * (1 + sind(270.0f * temp_f30));
        temp_r31->scale = temp_f31 * (temp_r31->vel.x * temp_f31);
        temp_r31->time += temp_r31->parManId;
        if (temp_r31->time > 255) {
            temp_r31->pos.x = (4.0f * (((1.0f / 256.0f) * ((s32)frand() & 0x1FF)) - 1));
            temp_r31->pos.y = 0;
            temp_r31->pos.z = (4.0f * (((1.0f / 256.0f) * ((s32)frand() & 0x1FF)) - 1));
            temp_r31->time = 0;
    ...
    particle->pos.x = model->pos.x;
    particle->pos.z = model->pos.z;
}
...
void fn_1_6640(HU3DMODEL *model, HU3DPARTICLE *particle, Mtx matrix)
{
    ...
    if (!particle->dataCnt) {
        particle->dataCnt = 1;
        temp_r31 = particle->data;
        for (temp_r28 = 0; temp_r28 < particle->maxCnt; temp_r31++, temp_r28++) {
            temp_r31->scale = 15;
            ...
            temp_r31->vel.x = temp_f30 * sind(temp_f31);
            temp_r31->vel.y = 100.0f * (0.02f * (((1.0f / 256.0f) * ((s32)frand() & 0x1FF)) - 1.0f));
            temp_r31->vel.z = temp_f30 * cosd(temp_f31);
            temp_r31->color.r = temp_r31->color.g = temp_r31->color.b = 255;
            temp_r31->color.a = 0;
            temp_r31->time = ((float)particle->prevCount) * ((float)temp_r28 / (float)particle->maxCnt);
        }
#ifdef NON_MATCHING
        temp_f29 = 0.0f;
        temp_f28 = 0.0f;
    ...
    for (temp_r28 = 0; temp_r28 < particle->maxCnt; temp_r31++, temp_r28++) {
        if (temp_r31->time >= 0) {
            if (temp_r31->time == 0) {
                temp_r31->pos.x += temp_r31->vel.x + temp_f29;
                temp_r31->pos.y += temp_r31->vel.y;
                temp_r31->pos.z += temp_r31->vel.z + temp_f28;
#if VERSION_PAL
                temp_r31->vel.y += -1.2f;
#else
                temp_r31->vel.y += -1.0000001f;
#endif
                if (temp_r31->color.a) {
...
void fn_1_6AE8(HU3DMODEL *model, HU3DPARTICLE *particle, Mtx matrix)
{
    ...
    if (!particle->dataCnt) {
        ...
        for (temp_r29 = 0; temp_r29 < particle->maxCnt; temp_r31++, temp_r29++) {
            ...
            temp_r31->pos.y = 0;
            temp_r31->pos.z = 0;
            temp_r31->vel.x = 100.0f * (0.05f * (((1.0f / 256.0f) * ((s32)frand() & 0x1FF)) - 1.0f));
            temp_r31->vel.y = 100.0f * (0.05f * (((1.0f / 256.0f) * ((s32)frand() & 0x1FF)) - 1.0f));
            temp_r31->vel.z = 100.0f * (0.05f * (((1.0f / 256.0f) * ((s32)frand() & 0x1FF)) - 1.0f));
            temp_r31->color.a = 128;
            temp_r31->time = 0;
        }
    }
    temp_r31 = particle->data;
    for (temp_r29 = 0; temp_r29 < particle->maxCnt; temp_r29++, temp_r31++) {
        ...
        temp_r31->vel.x *= 0.92f;
        temp_r31->vel.y *= 0.92f;
        temp_r31->vel.z *= 0.92f;
        temp_r28 = temp_r31->color.a;
        temp_r28 -= 4;
        if (temp_r28 < 0) {
            temp_r31->time = -1;
            temp_r28 = 0;
        }
        temp_r31->color.a = temp_r28;
    }
    if (temp_r27 == particle->maxCnt) {
        model->attr |= 0x1;
    }
...
void fn_1_6E5C(OMOBJ *object)
{
    ...
    VECNormalize(&sp8, &sp8);
    HuAudFXListnerSetEX(&sp14, &sp8, 10000, 34000.0f / REFRESH_RATE_F, 0, 300, 300);
    object->objFunc = fn_1_72EC;
}
    ...
    switch (fn_1_1240()) {
        case 2:
            ...
            if (lbl_1_data_260[0] < 1.0f) {
                lbl_1_data_260[0] += 5.0f / (REFRESH_RATE_F * 4);
                if (lbl_1_data_260[0] > 1.0f) {
