...
void fn_1_6914(OMOBJ *object);
void fn_1_7280(OMOBJ *object);
void fn_1_75C0(OMOBJ *object);
void fn_1_7C48(OMOBJ *object);
void fn_1_891C(OMOBJ *object);

OMOBJ *fn_1_347C(void);

void fn_1_32C4(HUPROCESS *objman)
{
    lbl_1_bss_70 = objman;
    fn_1_8EAC();
...
void fn_1_4104(OMOBJ *object);

void fn_1_6C60(OMOBJ *object);
void fn_1_7430(OMOBJ *object);
void fn_1_7974(OMOBJ *object);
void fn_1_8474(OMOBJ *object);
...
void fn_1_3DDC(OMOBJ *object);

void fn_1_4180(HU3DMODEL *model, Mtx matrix);
void fn_1_49AC(HU3DMODEL *model, Mtx matrix);
void fn_1_4E64(HU3DMODEL *model, Mtx matrix);

OMOBJ *fn_1_347C(void)
{
    OMOBJ *object = omAddObjEx(lbl_1_bss_70, 127, 15, 0, -1, fn_1_3DDC);
    Work347C *work = object->data = HuMemDirectMallocNum(HEAP_HEAP, sizeof(Work347C), HU_MEMNUM_OVL);
    Work347C *work2 = work;
    ...
    object->mdlId[0] = id = Hu3DHookFuncCreate(fn_1_4E64);
    Hu3DModelCameraSet(id, HU3D_CAM0);
    Hu3DModelLayerSet(id, 5);
    modelP = &Hu3DData[id];
    modelP->hookData = work;
    work->unkA1C[4] = HuSprAnimRead(HuDataReadNum(DATA_MAKE_NUM(DATADIR_M455, 21), HU_MEMNUM_OVL));
    work->unkA1C[5] = HuSprAnimRead(HuDataReadNum(DATA_MAKE_NUM(DATADIR_M455, 22), HU_MEMNUM_OVL));
    work->unkA1C[6] = HuSprAnimRead(HuDataReadNum(DATA_MAKE_NUM(DATADIR_M455, 23), HU_MEMNUM_OVL));
    work->unkA1C[7] = HuSprAnimRead(HuDataReadNum(DATA_MAKE_NUM(DATADIR_M455, 24), HU_MEMNUM_OVL));
    work->unkA1C[0] = HuSprAnimRead(HuDataReadNum(DATA_MAKE_NUM(DATADIR_M455, 17), HU_MEMNUM_OVL));
    work->unkA1C[1] = HuSprAnimRead(HuDataReadNum(DATA_MAKE_NUM(DATADIR_M455, 18), HU_MEMNUM_OVL));
    work->unkA1C[2] = HuSprAnimRead(HuDataReadNum(DATA_MAKE_NUM(DATADIR_M455, 19), HU_MEMNUM_OVL));
    work->unkA1C[3] = HuSprAnimRead(HuDataReadNum(DATA_MAKE_NUM(DATADIR_M455, 20), HU_MEMNUM_OVL));
    work->unkA1C[8] = HuSprAnimRead(HuDataReadNum(DATA_MAKE_NUM(DATADIR_M455, 25), HU_MEMNUM_OVL));
    object->mdlId[1] = id = Hu3DHookFuncCreate(fn_1_4180);
    Hu3DModelCameraSet(id, HU3D_CAM0);
    ...
    object->mdlId[3] = id = Hu3DModelCreateFile(DATA_MAKE_NUM(DATADIR_M455, 5));
    Hu3DModelPosSet(id, 0, 0, -5000);
    Hu3DModelScaleSet(id, 2, 2, 2);
    Hu3DModelCameraSet(id, HU3D_CAM0);
    Hu3DModelLayerSet(id, 1);
    id = Hu3DTexScrollCreate(object->mdlId[3], "S3TCsk");
    Hu3DTexScrollPosMoveSet(id, -0.0055f * REFRESH_FREQ, 0, 0);
    id = Hu3DTexScrollCreate(object->mdlId[3], "pa_sk3");
    Hu3DTexScrollPosMoveSet(id, -0.0125f * REFRESH_FREQ, 0, 0);

    object->mdlId[4] = id = Hu3DModelCreateFile(DATA_MAKE_NUM(DATADIR_M455, 6));
    Hu3DModelPosSet(id, 0, 0, -3000);
    Hu3DModelScaleSet(id, 1.2f, 1.2f, 1.2f);
    Hu3DModelCameraSet(id, HU3D_CAM0);
    Hu3DModelLayerSet(id, 1);

    object->mdlId[8] = id = Hu3DHookFuncCreate(fn_1_49AC);
    Hu3DModelCameraSet(id, HU3D_CAM0);
    Hu3DModelLayerSet(id, 2);
    modelP = &Hu3DData[id];
    modelP->hookData = work;

    object->mdlId[10] = id = Hu3DModelCreateFile(DATA_MAKE_NUM(DATADIR_M455, 0));
    Hu3DModelPosSet(id, 0, 0, 0);
    Hu3DModelCameraSet(id, HU3D_CAM0);
    Hu3DModelLayerSet(id, 3);
    Hu3DModelShadowMapSet(object->mdlId[10]);
    for(i=0; i<4; i++) {

        object->mdlId[i+11] = id = Hu3DModelCreateFile(DATA_MAKE_NUM(DATADIR_M455, 1));
        Hu3DModelCameraSet(object->mdlId[i+11], HU3D_CAM0);
        Hu3DModelLayerSet(object->mdlId[i+11], 3);
        Hu3DModelPosSet(object->mdlId[i+11], lbl_1_data_1D8[i].x, lbl_1_data_1D8[i].y, lbl_1_data_1D8[i].z);
        Hu3DModelAttrSet(object->mdlId[i+11], HU3D_MOTATTR_SHAPE_LOOP);
        Hu3DMotionShapeTimeSet(object->mdlId[i+11], (0.25*i)*Hu3DMotionShapeMaxTimeGet(object->mdlId[i+11]));
    }
    modelP = &Hu3DData[object->mdlId[0]];
...
void fn_1_3DDC(OMOBJ *object)
{
    ...
    Hu3DModelPosSet(object->mdlId[10], 0, work->unkA44, 0);
    for(i=0; i<4; i++) {
        Hu3DModelPosSet(object->mdlId[i+11], lbl_1_data_1D8[i].x, work->unkA44+lbl_1_data_1D8[i].y, lbl_1_data_1D8[i].z);
    }
...
void fn_1_59A0(HU3DMODEL *model, Mtx matrix);
...
void fn_1_4A14(HU3DMODEL *model, Mtx matrix)
{
    Work347C *work = model->hookData;
    Work347C *work2 = work;
    Work347CUnk4 *workUnk4 = &work2->unk4[0];
...
void fn_1_4B1C(HU3DMODEL *model, Mtx matrix)
{
...
void fn_1_6914(OMOBJ *object)
{
    ...
    anim = HuSprAnimRead(HuDataReadNum(DATA_MAKE_NUM(DATADIR_M455, 26), HU_MEMNUM_OVL));
    for(i=0; i<8; i++, work++) {
        work->unk10 = anim;
        work->unk0 = i;
...
s32 fn_1_6CB0(Vec *arg0, float arg1)
{
    ...
    temp_r28->blendMode = 1;
    temp_r30 = temp_r28->data;
    for(i=0; i<temp_r28->maxCnt; i++, temp_r30++) {
        ...
        temp_r30->vel.x = temp_f31*(0.65f*(50.0*(temp_f28*sind(temp_f29))));
        temp_r30->vel.z = temp_f31*(0.65f*(50.0*(temp_f28*cosd(temp_f29))));
        temp_r30->vel.y = temp_f31*(50*temp_f26*temp_f25);
        temp_r30->time = 0;
        temp_r30->parManId = ((s32)frand()%16)+45;
        temp_r30->zRot = (s32)frand()%360;
        temp_r30->scale = 145;
        temp_r30->pos.x = 0.05f*(((s32)frand() & 0x7F)-64);
        temp_r30->pos.y = 0.65f*(((s32)frand() & 0x7F)-64);
        temp_r30->pos.z = 0.05f*(((s32)frand() & 0x7F)-64);
        temp_r30->color.r = ((s32)frand()%64)+192;
        temp_r30->color.g = ((s32)frand()%64)+192;
        temp_r30->color.b = ((s32)frand()%64)+192;
        temp_r30->color.a = 64;
    }
    if(arg1 < 0.0f) {
        arg1 = 1.0f;
...
void fn_1_7280(OMOBJ *object)
{
    ...
    for(i=0; i<object->mdlcnt; i++) {
        if(i == 0) {
            object->mdlId[i] = Hu3DModelCreateFile(DATA_MAKE_NUM(DATADIR_M455, 9));
        } else {
            object->mdlId[i] = Hu3DModelLink(object->mdlId[0]);
        }
        Hu3DModelCameraSet(object->mdlId[i], HU3D_CAM0);
        Hu3DModelLayerSet(object->mdlId[i], 6);
        Hu3DModelAttrSet(object->mdlId[i], HU3D_ATTR_DISPOFF);

    }
    object->stat |= 0x100;
    object->objFunc = fn_1_7368;
}
...
void fn_1_7368(OMOBJ *object)
{
    s32 i;
    for(i=0; i<object->mdlcnt; i++) {
        HU3DMODEL *modelP = &Hu3DData[object->mdlId[i]];
        if(!(modelP->attr & HU3D_ATTR_DISPOFF)) {
           if(Hu3DMotionTimeGet(object->mdlId[i]) >= Hu3DMotionMaxTimeGet(object->mdlId[i])) {
               Hu3DModelAttrSet(object->mdlId[i], HU3D_ATTR_DISPOFF);
           }
        }
    }
...
s32 fn_1_7434(Vec *pos, float scale)
{
    ...
    for(i=0; i<lbl_1_bss_64->mdlcnt; i++) {
        HU3DMODEL *modelP = &Hu3DData[lbl_1_bss_64->mdlId[i]];
        if(modelP->attr & HU3D_ATTR_DISPOFF) {
            break;
        }
    }
    ...
    Hu3DMotionTimeSet(lbl_1_bss_64->mdlId[i], 0);
    Hu3DMotionSpeedSet(lbl_1_bss_64->mdlId[i], 1);
    Hu3DModelPosSet(lbl_1_bss_64->mdlId[i], pos->x, pos->y, pos->z);
    Hu3DModelScaleSet(lbl_1_bss_64->mdlId[i], scale, scale, scale);
    Hu3DModelAttrReset(lbl_1_bss_64->mdlId[i], HU3D_ATTR_DISPOFF);
    return i;
}

void fn_1_76B0(OMOBJ *object);
...
void fn_1_75C0(OMOBJ *object)
{
    ...
    s32 i;
    HU3DMODEL *modelP;
    ANIMDATA *anim = HuSprAnimRead(HuDataReadNum(DATA_MAKE_NUM(DATADIR_M455, 26), HU_MEMNUM_OVL));

    object->data = anim;
    object->mdlId[0] = Hu3DParticleCreate(anim, 64);
    Hu3DModelCameraSet(object->mdlId[0], HU3D_CAM0);
    Hu3DModelLayerSet(object->mdlId[0], 3);
    Hu3DModelAttrReset(object->mdlId[0], HU3D_ATTR_PARTICLE_KILL);
    modelP = &Hu3DData[object->mdlId[0]];
    temp_r30 = modelP->hookData;
    temp_r29 = temp_r30->data;
    temp_r30->blendMode = 1;
    for(i=0; i<temp_r30->maxCnt; i++, temp_r29++) {
        temp_r29->scale = 0;
    }
    object->objFunc = fn_1_76B0;
}

void fn_1_76B0(OMOBJ *object)
{
    HU3DMODEL *modelP = &Hu3DData[object->mdlId[0]];
    HU3DPARTICLE *temp_r29 = modelP->hookData;
    HU3DPARTICLEDATA *temp_r30 = temp_r29->data;
    s32 i;
    for(i=0; i<temp_r29->maxCnt; i++, temp_r30++) {
        if(temp_r30->scale <= 0.0f) {
            continue;
        }
        if(++temp_r30->time > 360) {
            temp_r30->time -= 360;
        }
        temp_r30->pos.x += temp_r30->vel.x*sind(2.0f*temp_r30->time);
        temp_r30->pos.y += temp_r30->vel.y;
        if(temp_r30->pos.y >= 0.0f) {
            fn_1_6698(&temp_r30->pos, 0.00625f*temp_r30->scale, 1, REFRESH_RATE / 4);
            temp_r30->scale = 0;
        }
...
{
    s32 i;
    HU3DMODEL *modelP = &Hu3DData[lbl_1_bss_60->mdlId[0]];
    HU3DPARTICLE *temp_r30 = modelP->hookData;
    HU3DPARTICLEDATA *temp_r31 = temp_r30->data;
    for(i=0; i<temp_r30->maxCnt; i++, temp_r31++) {
        if(temp_r31->scale <= 0.0f) {
            break;
        }
    }
    if(i >= temp_r30->maxCnt) {
        return -1;
    }
    if(scale <= 0.0f) {
        scale = 1.0f;
    ...
    temp_r31->pos = *pos;
#if VERSION_PAL
    temp_r31->vel.x = 1.2f * (1.5f+(0.2f*(0.007874016f*((s32)frand() & 0x7F)))) * 0.5f;
    temp_r31->vel.z = 1.2f * (1.5f+(0.2f*(0.007874016f*((s32)frand() & 0x7F))));
    temp_r31->vel.y = 1.2f * (1.5f+(0.2f*(0.007874016f*((s32)frand() & 0x7F)))) * 2.0f;
#else
    temp_r31->vel.x = (1.5f+(0.2f*(0.007874016f*((s32)frand() & 0x7F))))*0.5f;
    temp_r31->vel.z = (1.5f+(0.2f*(0.007874016f*((s32)frand() & 0x7F))));
    temp_r31->vel.y = (1.5f+(0.2f*(0.007874016f*((s32)frand() & 0x7F))))*2.0f;
#endif
    temp_r31->time = (s32)frand()%360;
    temp_r31->scale = 20*scale;
    return i;
}
...
void fn_1_8578(OMOBJ *object, Work891C *workP)
{
    ...
    for(i=0; i<num; i++, workP++) {
        ...
        modelMtx = &Hu3DData[workP->unk0].mtx;
...
void fn_1_91B8(HU3DMODEL *model, HU3DPARTICLE *particle, Mtx matrix);

void fn_1_8EAC(void)
{
    StructBss48 *workP = lbl_1_bss_48 = HuMemDirectMallocNum(HEAP_HEAP, sizeof(StructBss48), HU_MEMNUM_OVL);
    HU3DPARTICLE *particle;
    HU3DMODEL *modelP;
    s16 *newWork;
    s32 modelId;
    memset(workP, 0, sizeof(StructBss48));
    workP->unk0[0] = HuSprAnimRead(HuDataReadNum(DATA_MAKE_NUM(DATADIR_M455, 13), HU_MEMNUM_OVL));
    workP->unk0[1] = HuSprAnimRead(HuDataReadNum(DATA_MAKE_NUM(DATADIR_M455, 14), HU_MEMNUM_OVL));
    workP->unk0[2] = HuSprAnimRead(HuDataReadNum(DATA_MAKE_NUM(DATADIR_M455, 15), HU_MEMNUM_OVL));
    workP->unk0[3] = HuSprAnimRead(HuDataReadNum(DATA_MAKE_NUM(DATADIR_M455, 16), HU_MEMNUM_OVL));
    workP->unk20.y = 1;
    workP->unk20.z = 0;
    ...
    switch(newWorkP[2]) {
        case 0:
            ...
            if(newWorkP[1]) {
                ...
                sp18.y *= temp_f29;
                sp18.z *= temp_f29;
                temp_f23 = 3200.0f/particle->maxCnt;
                for(i=0; i<particle->maxCnt; i++, temp_r31++) {
                    temp_f26 = 500.0+((temp_f23*i)+((0.25f*temp_f23)*((float)((s32)frand() & 0xFFFF)*0.0000152587890625)));
                    temp_f25 = temp_f26/3200;
                    temp_r31->accel.x = temp_f26;
                    temp_r31->pos.x = 1000+(temp_f26*sp18.x);
                    temp_r31->pos.y = 4800+(temp_f26*sp18.y);
                    temp_r31->pos.z = -3500+(temp_f26*sp18.z);
                    temp_r31->scale = ((0.7f*(temp_f25*temp_f25))+0.3f)*(lbl_1_data_6A0[newWorkP[1]]*(0.7f+(0.3f*((float)((s32)frand() & 0xFFFF)*0.0000152587890625))));
                    temp_r31->color.r = (s32)(((float)((s32)frand() & 0xFFFF)*0.0000152587890625)*160.0)+32;
                    temp_r31->color.g = (s32)(((float)((s32)frand() & 0xFFFF)*0.0000152587890625)*96.0)+32;
                    temp_r31->color.b = (s32)(((float)((s32)frand() & 0xFFFF)*0.0000152587890625)*128.0)+32;
                    temp_r31->color.a = (255*lbl_1_data_6B0[newWorkP[1]]*(1.0-(0.4*temp_f25)))-(s32)(((float)((s32)frand() & 0xFFFF)*0.0000152587890625)*16.0);
                    temp_r31->accel.z = temp_r31->color.a;
                }
                newWorkP[2]++;
            } else {
                temp_r31->pos.x = 1000;
        ...
        case 1:
            ...
            temp_r31 = particle->data;
            for(i=0; i<particle->maxCnt; i++, temp_r31++) {
                temp_r31->pos.x = 1000+(sp24.x*temp_r31->accel.x);
                temp_r31->pos.y = 4800+(sp24.y*temp_r31->accel.x);
                temp_r31->pos.z = -3500+(sp24.z*temp_r31->accel.x);
                temp_r31->color.a = temp_r31->accel.z*workP->unk20.y;
            }
            break;
    }
