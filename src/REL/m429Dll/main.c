...
float lbl_1_data_FFC[4][4] = {
	0, 0, 320, 240,
	0, 240, 320, 240,
	320, 0, 320, 240,
	320, 240, 320, 240
};
float lbl_1_data_103C[4][4] = {
	2, 2, 316, 236,
	2, 242, 316, 236,
	322, 2, 316, 236,
	322, 242, 316, 236
...
s32 lbl_1_data_12B0[8] = {
	0x003C002C, 0x003C002E,
	0x003C002C, 0x003C002E,
	0x003C002D, 0x003C002E,
	0x003C002D, 0x003C002E
};
...
s32 lbl_1_data_12E0[4][3] = {
	0x003C0024, 0x003C0030, 0x003C0025,
	0x003C0026, 0x003C0030, 0x003C0027,
	0x003C0028, 0x003C0030, 0x003C0029,
	0x003C002A, 0x003C0030, 0x003C002B,
};
...
Data13A8Struct lbl_1_data_13A8 = {
	0.5f,
	100.0f,
	130.0f,
	15
...
Data13A8Struct lbl_1_data_13B8 = {
	0.6f,
	110.0f,
	120.0f,
	12
...
Data13A8Struct lbl_1_data_13C8 = {
	0.7f,
	120.0f,
	110.0f,
	9
...
Data13A8Struct lbl_1_data_13D8 = {
	0.8f,
	130.0f,
	100.0f,
	6
...
void fn_1_23B4(void)
{
	...
	for(temp_r30=0; temp_r30<4; temp_r30++) {
		...
		print8(24, 96+(16*temp_r30), 1.5f, "%d %d %d M%2d %04x %2d %2d %d %d", temp_r31->unk100, temp_r31->unk10C, temp_r31->unk104, temp_r31->unk8C, temp_r31->unkE8, temp_r31->unkEC, temp_r31->unkF0, temp_r31->unk80, temp_r31->unk8C);
	}
}
...
void fn_1_8F68(omObjData *object)
{
	...
	temp_r31->unkB4 = espEntry(0x3C0031, 133, 0);
	...
	for(temp_r29=0; temp_r29<4; temp_r29++) {
		...
		espDispOff(temp_r31->unkC8[temp_r29][0]);
		temp_r31->unkC8[temp_r29][1] = espEntry(0x3C003C, 128, 0);
...
void fn_1_D5E8(omObjData *object)
{
	...
	object->model[1] = Hu3DModelCreateFile(0x3C0022);
	...
	object->model[2] = Hu3DModelCreateFile(0x3C0023);
...
void ObjectSetup(void)
{
	...
	lbl_1_bss_1A = Hu3DModelCreateFile(0x3C002F);
	...
	lbl_1_bss_C = HuSprAnimReadFile(0x3C003F);
