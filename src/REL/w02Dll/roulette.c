...
void fn_1_BCFC(void)
{
    ...
    CreateBoardTextWindow(MAKE_MESSID(0x13, 0x00));
    HuAudFXPlay(0x44);
    temp_r29 = fn_1_BE88();
    BoardStatusShowSetAll(0);
    CreateBoardTextWindow(MAKE_MESSID(0x13, 0x01));
...
s32 fn_1_BE88(void)
{
    ...
    CreateBoardTextWindow(MAKE_MESSID(0x13, 0x02));
    ...
    if (var_r30 == -1) {
        CreateBoardTextWindow(MAKE_MESSID(0x13, 0x07));
    }
    return var_r30;
}
...
void fn_1_D3AC(void)
{
    ...
    CreateBoardTextWindow(MAKE_MESSID(0x13, 0x08));
    BoardStatusShowSetAll(1);
...
s32 fn_1_D8C4(void)
{
    ...
    u32 temp_r21;
    CreateBoardTextWindow(MAKE_MESSID(0x13, 0x09));
